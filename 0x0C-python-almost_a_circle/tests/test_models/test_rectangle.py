...
class RectangleTestCase(unittest.TestCase):
    ...
    def test_update(self, *args, **kwargs):
        ...
        # Case 8
        self.r4.update(**{ 'id': 89, 'width': 1, 'height': 2 })
        ...
        # Case 9
        self.r4.update(**{ 'id': 89, 'width': 1, 'height': 2, 'x': 3 })
        ...
        # Case 10
        self.r4.update(**{ 'id': 89, 'width': 1, 'height': 2, 'x': 3, 'y': 4 })
